...
Command: npx gltfjsx@6.5.2 MacBookmodel.gltf 
*/
...
export function MacBookModel(props) {
  const { nodes, materials } = useGLTF('/MacBookmodel.gltf')
  const ref = useRef();
  ...
  useFrame(()=>{
    ...
    // if(ref.current.position.y < -height/1){
  ...
  return (
    <group {...props} dispose={null} ref={ref}>
      <group position={[0, 0.519, 0]} scale={0.103}>
        ...
        <mesh geometry={nodes.FrontCameraRing001.geometry} material={materials['CameraRIngBlack.002']} position={[-0.155, 19.571, -16.151]} scale={5.796} />
        ...
        <mesh geometry={nodes.KeyboardKeyHole.geometry} material={materials['Keyboard.001']} position={[-11.786, -0.152, -8.301]} scale={5.796} />
        <mesh geometry={nodes.RubberFoot.geometry} material={materials.DarkRubber} position={[-11.951, -0.751, 7.857]} scale={5.796} />
        ...
        <group position={[0.007, -0.472, -10.412]} rotation={[1.311, 0, 0]} scale={5.796}>
          ...
          <mesh geometry={nodes.AppleLogo000.geometry} material={materials['AppleLogo.004']} position={[0.005, -0.111, -1.795]} rotation={[-Math.PI, 0, -Math.PI]} scale={0.579} />
        </group>
      </group>
    </group>
  )
...
useGLTF.preload('/MacBookmodel.gltf')
